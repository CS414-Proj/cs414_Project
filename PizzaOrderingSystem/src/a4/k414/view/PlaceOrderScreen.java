...
public class PlaceOrderScreen extends JFrame {
	...
	private JTextField homeAddress = new JTextField(25);
	private JTextField city = new JTextField(25);
	private JTextField zipcode = new JTextField(25);
	...
	public void setFonts() {
		...
		homeAdd.setFont(newFFont);
		homeAdd.setForeground(Color.BLUE);
		cityLabel.setFont(newFFont);
		cityLabel.setForeground(Color.BLUE);
		zip.setFont(newFFont);
		...
		homeAddress.setFont(newFFont);
		city.setFont(newFFont);
		zipcode.setFont(newFFont);
	...
	public void setBounds(){
		...
		homeAdd.setBounds(80,700,150,25);
		homeAddress.setBounds(260,700,150,25);
		cityLabel.setBounds(80,750,100,25);
		city.setBounds(260,750,100,25);
		zip.setBounds(500,750,100,25);
		zipcode.setBounds(660,750,100,25);
	...
	public JTextField gethomeAddressField() {
		return homeAddress;
	}
