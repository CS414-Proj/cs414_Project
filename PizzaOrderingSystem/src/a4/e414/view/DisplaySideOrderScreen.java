...
public class DisplaySideOrderScreen extends JFrame {
	
	public static void main(String args[]){
		String[] inp = {"a", "b","c", "d","e"};
		new DisplaySideOrderScreen(inp, inp);
				
	}

	private JLabel welcomeLabel = new JLabel("Select Side");
	...
	public DisplaySideOrderScreen(String[] size, String[] type){
	...
	public void setBounds(){
		...
		welcomeLabel.setBounds(250,30,500,65);
